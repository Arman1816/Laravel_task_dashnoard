            ...
            {!! Form::open(['route' => ['admin.setting.update',$setting->id], 'method' => 'put', 'enctype'=>"multipart/form-data",]) !!}
                <div class="tab-content">
                    ...
                    <div class="form-group {{ $errors->has('url') ? ' has-error' : '' }}">
                        {!! Form::label('url','Url:') !!}
                        {!! Form::text('url', $setting->url, ['class'=>'form-control', 'placeholder'=>'Url' ]) !!}
                    ...
                    <div class="form-group {{ $errors->has('token') ? ' has-error' : '' }}">
                        ...
                        {!! Form::text('token', $setting->token, ['class'=>'form-control', 'placeholder'=>'Token' ]) !!}
                        @if ($errors->has('token'))
                            <span class="help-block"><strong>{{ $errors->first('token') }}</strong></span>
                        @endif
                    </div>
